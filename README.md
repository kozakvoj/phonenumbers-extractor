# Telephone Numbers Extractor

Extracts telephone numbers from given text.

## API
extractNumbers(text, minNumberLength)

minNumberLength - specify the shortest number that should be extracted.
...
extractor.extractNumbers(text, 5);
```
